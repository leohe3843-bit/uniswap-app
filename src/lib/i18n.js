...
// School community
navSchools: '学校',
schoolsPageTitle: '学校社区',
schoolsPageDesc: '找到你的学校，加入专属社区',
schoolsSearchPH: '搜索学校名称、缩写或城市...',
schoolsCount: '所覆盖大学',
schoolsStatesCount: '个州和地区',
schoolCommunity: '社区',
schoolBulletin: '校园公告板',
schoolBulletinEmpty: '暂无公告，来发第一条吧！',
schoolBulletinPH: '分享校园生活、二手信息、求助...',
schoolBulletinPost: '发布',
schoolItems: '在售商品',
schoolWants: '求购信息',
schoolItemsEmpty: '暂无商品，去发布一个吧！',
schoolWantsEmpty: '暂无求购，发布你的需求！',
schoolViewAll: '查看全部',
schoolAbout: '关于',
schoolLocation: '位置',
schoolStudents: '社区成员',
schoolVerified: '已认证校友',
schoolJoinCommunity: '加入社区',
schoolPostItem: '在此发布商品',
schoolBrowseItems: '浏览本校商品',
schoolNearby: '附近学校',
schoolBackToAll: '返回所有学校',

// Home - Hero
homeTitle: '校园二手，轻松搞定',
homeSubtitle: '在你的学校周边找到最划算的二手好物',
heroTagline: '留学生的校园二手信息平台',
heroDesc: '覆盖全美 Top 50 高校的留学生二手物品信息交换平台。我们只做信息桥梁，帮你找到最划算的好物，不参与任何交易。',
...
phil2Title: '绿色可持续',
phil2Desc: '减少不必要的浪费，让闲置物品流转起来。二手不是将就，而是一种自觉、环保的校园生活方式。',
phil3Title: '社区连接',
phil3Desc: '打破校园之间的信息壁垒，让各个留学生社区更紧密。不只是买卖，更是一种生活方式和经验的分享。',
phil4Title: '信息透明',
...
adv2Title: '校园专属，精准匹配',
adv2Desc: '覆盖全美 50 所顶尖高校的学生，商品都在你身边。步行或短途就能取货，省时省力。',
adv3Title: '隐私优先，安全放心',
adv3Desc: '站内沟通不暴露个人信息，你可以自主选择何时、如何与对方联系。保护你的隐私安全。',
adv4Title: '操作极简，3分钟上手',
adv4Desc: '邮箱一键登录，拍照即可发布。没有复杂的认证流程，没有繁紐的操作步骤，让分享变得轻松。',
adv5Title: '全美覆盖，跨校交换',
adv5Desc: '覆盖全美 50 所顶尖高校，支持跨校浏览和信息交换，扩大你的选择范围。',
adv6Title: '搬家季神器',
adv6Desc: '毕业清仓还是开学置办？SwapU 帮你在最需要的时候找到最合适的物品，让搬家不再头疼。',
...
schoolsSectionDesc: '覆盖全美 50 所顶尖高校，每所学校都有专属社区',

// CTA
ctaTitle: '开始探索校园好物',
ctaDesc: '加入 SwapU，发现身边的学生社区的好物',
ctaBrowse: '浏览商品',
ctaPost: '发布商品',
...
// Moving season
movingBannerTitle: '搬家季专场',
movingBannerDesc: '毕业季来了！大量好物低价清仓，错过等一年',
...
// Want to Buy
wantTitle: '求购专区',
wantSubtitle: '发布你的需求，让有货的同学主动找到你',
wantPostBtn: '发布求购',
wantBudget: '预算',
wantContact: '联系TA',
wantEmpty: '暂无求购信息',
...
safetyTip1Desc: '建议在校园内的图书馆、学生中心、咖啡店等公共区域进行物品交接。避免去陌生人的私人住所。',
safetyTip2Title: '白天交易更安全',
safetyTip2Desc: '尽量安排在白天进行交易，避免深夜或光线不好的时段和地点。',
safetyTip3Title: '告知椋友你的行程',
...
safetyTip5Desc: '建议使用 Venmo、Zelle 等有记录的电子支付方式，避免大额现金交易。保存转账记录作为凭证。',
safetyTip6Title: '信任你的直觉',
safetyTip6Desc: '如果感到任何不安全或可疑，不要特豫，立即取消交易。你的安全永远比一笔交易更重要。',
...
faq2Q: 'SwapU 参与交易吗？',
faq2A: '不参与。SwapU 是一个纯信息平台，我们只提供买卖双方的信息展示和连接服务。所有交易由双方自行协商和完成，平台不介入也不承担交易相关责任。',
faq3Q: '如何联系卖家或买家？',
faq3A: '点击商品详情页的"联系卖家"按钮，即可查看对方的公开联系方式。建议优先使用微信或 WhatsApp 沟通。',
faq4Q: '可以发布哪些类型的商品？',
faq4A: '你可以发布家具、电子产品、教科书、厨具、服饰、交通工具、生活用品等分类二手物品。禁止发布违法物品、食品、荮品等。',
faq5Q: '遇到问题怎么办？',
faq5A: '如遇到虚假信息或不当行为，请通过页面底部的联系方式向我们举报，我们会及时处理。',
faq6Q: '我的个人信息安全吗？',
faq6A: '我们重视你的隐私。平台仅展示你选择公开的信息，不会向第三方出售或分享你的个人数据。',

// Footer
footerAbout: '关于 SwapU',
footerAboutDesc: 'SwapU 是专为在美高校留学生打造的二手物品信息平台，致力于连接校园社区，让闲置好物重新流转。',
footerLinks: '快速链接',
...
footerRightsText: '本平台所有内容（包括但不限于文字、图片、设计、标识）的知识产权归 SwapU 团队所有。未经书面许可，不得转载、复制或用于商业用途。',
footerDisclaimerText: '本网站最终解释权归 SwapU 团队所有。我们保留随时修改、更新平台规则和服务条款的权利，修改后的条款将在网站公布后立即生效。',
...
schoolBulletinEmpty: 'No posts yet — be the first to share!',
...
schoolItemsEmpty: 'No items yet — post one!',
schoolWantsEmpty: 'No requests yet — post yours!',
...
heroDesc: 'Covering the top 50 US universities. We connect buyers and sellers as an information bridge — no transactions, no middlemen.',
...
adv2Desc: 'Serving 50 top US universities. Everything is nearby — walk or take a short trip to pick up, saving time and effort.',
